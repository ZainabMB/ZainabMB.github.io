...
</li><li>NFR4: Location is only accessed if the user grants permission (security)</li><li>NFR5: Show the 5 nearest community toilets to the user's location or the default location on the map(Usability)</li><li>NFR6: Each marker should be visible(Usability)</li><li> NFR7: Display the name of the community toilet after clicking the marker (Usability)</li><li>NFR8: The buttons should be visible and distinguishable (Usability)</li>><li>NFR9: Desired criteria only has two choices 'yes' or 'no'(Efficiency)</li><li>NFR10: Buttons for different wards should be distinguishable (usability)</li><li>NFR11: All toilets from the specific ward will be displayed(Efficiency)</li><li>NFR12: The buttons should be easily read and distinguished(Usability) </li> <li> NFR13: Desired criteria only has two choices 'yes' or 'no'(Efficiency)</li><li>NFR14: The buttons should be easily read and distinguished(Usability) </li> <li> NFR15: Desired criteria only has two choices 'yes' or 'no'(Efficiency)</li></ol> 
